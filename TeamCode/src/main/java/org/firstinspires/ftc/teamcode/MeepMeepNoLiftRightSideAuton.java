...
//                bring back second brick
                ...
                .splineToConstantHeading(new Vector2d(-51, 14), Math.toRadians(270))
                .splineToConstantHeading(new Vector2d(-65, 14), Math.toRadians(90))
                .splineToConstantHeading(new Vector2d(-66, 57), Math.toRadians(90))
                ...
                .splineToConstantHeading(new Vector2d(-44.1, 60.7), Math.toRadians(90))
                ...
                .lineToYConstantHeading(33)
                .splineToConstantHeading(new Vector2d(-44.1, 59.7), Math.toRadians(90))

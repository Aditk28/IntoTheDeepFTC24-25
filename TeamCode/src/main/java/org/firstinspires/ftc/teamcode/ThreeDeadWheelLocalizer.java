...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 1286.9488109957708; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -1439.1409471051488; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2089.160920564821; // x position of the perpendicular encoder (in tick units)
    }

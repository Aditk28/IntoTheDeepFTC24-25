...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 642.8869378344693; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -832.6581225675956; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2012.2355521491083; // x position of the perpendicular encoder (in tick units)
    }
